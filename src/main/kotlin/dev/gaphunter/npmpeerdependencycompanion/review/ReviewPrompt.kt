package dev.gaphunter.npmpeerdependencycompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.npmpeerdependencycompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.npmpeerdependencycompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "NPM Peer Dependency Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33814-npm-peer-dependency-companion/reviews"
